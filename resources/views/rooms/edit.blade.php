            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-edit me-2 text-warning"></i>Edit Room: {{ $room->room_number }}</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('rooms.update', $room) }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control @error('floor_number') is-invalid @enderror" 
                                       id="floor_number" name="floor_number" value="{{ old('floor_number', $room->floor_number) }}" required min="0">
                                @error('floor_number')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('room_type') is-invalid @enderror" id="room_type" name="room_type" required>
                                    ...
                                    <option value="quad" {{ old('room_type', $room->room_type) == 'quad' ? 'selected' : '' }}>Quad Room</option>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" class="form-control @error('capacity') is-invalid @enderror" 
                                       id="capacity" name="capacity" value="{{ old('capacity', $room->capacity) }}" required min="1">
                                @error('capacity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                ...
                                <select class="form-select @error('gender_type') is-invalid @enderror" id="gender_type" name="gender_type" required>
                                    <option value="male" {{ old('gender_type', $room->gender_type) == 'male' ? 'selected' : '' }}>Male Only</option>
                                    <option value="female" {{ old('gender_type', $room->gender_type) == 'female' ? 'selected' : '' }}>Female Only</option>
                                </select>
                                @error('gender_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                    ...
                                    <div class="col-md-3 col-6">
                                        <div class="form-check card p-2 h-100">
                                            <input class="form-check-input ms-1" type="checkbox" name="facilities[]" 
                                                   ...
                                                   {{ in_array($facility, old('facilities', $currentFacilities)) ? 'checked' : '' }}>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('rooms.index') }}" class="btn btn-secondary me-md-2">Cancel</a>
