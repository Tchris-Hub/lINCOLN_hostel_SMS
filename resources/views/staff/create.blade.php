        ...
        <div class="col-md-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-dark text-white py-3">
                    <h2 class="h5 mb-0">Add New Staff Member</h2>
                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-4">
                                    ...
                                    <select name="assigned_hostel_gender" class="form-control border-gray" required
                                        ...
                                        <option value="male" {{ old('assigned_hostel_gender') == 'male' ? 'selected' : '' }}>Male Hostel</option>
                                        <option value="female" {{ old('assigned_hostel_gender') == 'female' ? 'selected' : '' }}>Female Hostel</option>
                                    </select>
